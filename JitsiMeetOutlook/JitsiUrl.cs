...
// Should be updated to reflect https://github.com/jitsi/js-utils/blob/master/random/roomNameGenerator.js
...
namespace JitsiMeetOutlook
{
    class JitsiUrl
    {
        ...
        private static List<string> adjective = new List<string>
        {
